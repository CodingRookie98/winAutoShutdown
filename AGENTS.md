...
### Testing
*Note: Currently, there are no automated tests in the codebase.*
- If adding tests, use a framework like GTest or Qt Test and add them to a new `tests/` directory.
